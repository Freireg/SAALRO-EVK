...
littlefs/%.o littlefs/%.su: ../littlefs/%.c littlefs/subdir.mk
...
clean-littlefs:
	-$(RM) ./littlefs/lfs.d ./littlefs/lfs.o ./littlefs/lfs.su ./littlefs/lfs_util.d ./littlefs/lfs_util.o ./littlefs/lfs_util.su
